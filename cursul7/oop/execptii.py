...
folosim mecanismul try-except pentru a gestiona posibilele exceptii aparute in codul nostru, astfel incat programul sa NU se opreasca.

try:
    incercam ceva
    aici care s-ar putea  sa dea exceptie
...
# l = [1, 2, 3, 4]
# print(l[0])
# # daca as decomenta linia de mai jos, codul s-ar opri
# # print(l[210])
# try:
#     print(l[5])
...
Reguli pentru prinderea exceptiilor:
 ...
 care sa prinda orice alta exeptie la care nu ne-am gandit noi
"""
try:
    nr_par = int(input("Introduceti un numar par: \n"))
    assert nr_par % 2 == 0
# except Value Error as e: => daca facem as e, ii dam practic un nume de verificare exceptiei, si o putem folosi apoi in blocul ei
except ValueError:
    print("Nu ati introdus un numar.")
    ...
    # In general, nu vrem sa facem asa (adica sa nu specificam execptia pe care o prindem
