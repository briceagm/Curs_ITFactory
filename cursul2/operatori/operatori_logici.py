...
assert are_permis and varsta, "Nu ai voie sa conduci o masina"

nota1, nota2, nota3 = 1, 3, 2
# assert nota1 > 4 and nota2 > 4 and nota3 > 4, "Ai picat"

# OR - x sau y : adevarat daca cel putin una din conditiile x sau y este adevarata
