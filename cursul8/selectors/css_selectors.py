...
Putem inclusiv cauta dupa strucutura din html, pornind de unde vrem noi, si mergand doar in jos sau in lateral.
...
# Cautam un copil div, mai exact primul copil, iar apoi in acest div cautam un input.
