...
Dar putem avea si mai multe instructiuni de tip return, INSA doar una dintre ele va fi activa la o apelare, deoarece atunci cand Python gaseste un return, OPRESTE functia.
'''
...
print(ionel)
maria = functie_cu_multireturn(13)
print(maria)

# def functiea_mea(ceva):
