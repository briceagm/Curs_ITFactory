...
1. time.sleep(x)- codul "doarme" x secunde
        - indiferent daca elementul cautat, sau evenimnetul pe care il asteptam apare dupa mai putinn timp, Python va astepta tousi x secunde.
...
# In cazul in care elementul pe care il cautam nu este inca disponibil, putem face explicit wait
# logo_selector = chrome.find_element(By.XPATH, logo_xpath)
# print(logo_selector.text)
# print("Done")
